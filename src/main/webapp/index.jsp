                ...
                <div class="card-body">
                    <form action="LoginController" method="POST" class="form-sign">
                        <div class="form-group text-center">
                            ...
                            <br>
                            <label for=""> Bienvenido al Sistema</label>
                        </div>
                        <div class="form-group">
                            <label for="">Usuario:</label>
                            <input type="text" name="user" class="form-control" value="Test">
                        </div>
                        <div class="form-group">
                            <label for="">Contraseña:</label>
                            <input type="password" name="password" class="form-control" value="test">
                        </div>
