    ...
    <div class="d-flex">
        ...
        <div class="col-sm-8">
            <form action="ProductController?menu=product" method="POST" style="display: flex; margin-bottom: 15px;"
                ...
                <button type="submit" name="accion" value="list" class="btn btn btn-outline-info ml-2"><Span><i
                            class="fas fa-search"></i>Buscar</Span></button>
            </form>
                            ...
                            <td>
                                <form action="ProductController?menu=product" method="POST">
                                    ...
                                    <button type="submit" name="accion" value="editar" class="btn btn-warning"
                                        style="color: black;"><Span><i class="fas fa-edit"></i>Editar</Span></button>
