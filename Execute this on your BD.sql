...
( '4859623-1A', 'Jose Eduardo Ramos', '12 calle 21-24 zona 12', '1'),
( '4589685-9A', 'Alejandro Gonzalez Osorio', 'Recidenciales 12av 12-56', '1'),
( '5689826-9', 'Dayron Salazar Cazanas', '24 calle 18-25 Zona 1 La flores', '1'),
( '6541568-3B', 'Miguel Diaz Canel', '15 calle 46-38 Zona 2 de Mixco', '1');
...
(4859856874859, 'HolaMundo','Jonathan Luis Rodriguez', '988252459', '1', 'jluis'),
(4856895968598, 'HolaTodos',':Luis Daniel Hernandez', '988252459', '1', 'ldhernan'),
(4858968958485, 'HolaCasa' ,'Mariano Ernesto Sanchez', '453536458', '1', 'mesanchez');
(4858968958484, 'test' ,'Test', '453535458', '1', 'Test');
...
delimiter $$
CREATE PROCEDURE `listSale` ( in condicion varchar(244))
begin
 select * from  `sales` where `serial_Number` like concat(condicion,'%') or `id_Sales` like concat(condicion,'%');
end $$
