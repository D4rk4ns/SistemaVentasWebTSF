                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <button type="submit" name="accion" value="searchClient" class="btn btn-outline-info ml-2">Buscar</button>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group d-flex">
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <button type="submit" name="accion" value="searchProduct" class="btn btn-outline-info ml-2">Buscar</button>
                                </div>
                                <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex col-sm-6 ml-auto">
                            <label for="" class="mt-2">No.Serie:</label>
                            <input type="text" name="noSerie " value="${NoSerie}" class="form-control ml-2">
                        </div>
                        <br>
                    ...
                    <div class="card-footer d-flex">
                        ...
                        <div class="col-sm-4  ml-auto">
                            <label name="cantTotal">Cantidad de Productos: ${cantTotal}</label>
                            <label name="total">Precio Total: ${total}</label>
